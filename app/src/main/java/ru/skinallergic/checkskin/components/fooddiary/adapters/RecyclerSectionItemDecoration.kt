...
import ru.skinallergic.checkskin.view_models.dateStaticFormater
import java.util.*
...
class RecyclerSectionItemDecoration(
    ...
    override fun onDrawOver(c: Canvas, parent: RecyclerView, state: RecyclerView.State) {
        ...
        for (i in 0 until parent.childCount) {
            ...
            val created = sectionCallback.getSectionHeader(position)
            val title = dateStaticFormater(Date(created.toString().toLong()*1000)).toString()
            header!!.text =title
